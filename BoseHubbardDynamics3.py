...
## simulation results
data = pyalps.loadIterationMeasurements(pyalps.getResultFiles(prefix=basename+'.dynamic'), what=['Energy', 'Overlap', 'Local density', 'Local density squared', 'One body density matrix', 'Density density'])
